        ...
        try{
            AsyncTask.execute(new Runnable() {
                ...
                public void run() {
                    // Create URL
                    try{
                        URL githubEndpoint = new URL("http://10.254.253.58:5000/get?src=" + srcPrefix + src);
        ...
        try{
            AsyncTask.execute(new Runnable() {
                ...
                public void run() {
                    // Create URL
                    try{
                        URL url = new URL("http://10.254.253.58:5000/file-upload");
...
//        }
        ...
        Request request = new Request.Builder()
                .url("http://10.254.253.58:5000/file-upload") // Replace with your server URL
                .post(requestBody)
                .build();
